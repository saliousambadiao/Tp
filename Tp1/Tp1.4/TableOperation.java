...
public class TableOperation {
  ...
  public static void main(String[] args) {
    ...
    String stringDispayed1 = (egalite)
      ? "The tables are the same"
      : "The tables are'nt the same";
    System.out.println(stringDispayed1);
    boolean equivalence = equality2(tab, tab2);
    String stringDispayed2 = (equivalence)
      ? " The tables have the same contain"
      : "The tables have'nt the same contain";
    System.out.println(stringDispayed2);
